...
proto.charError = function (buffer, i) {
  ...
  {
    str = "buffer.toString('utf8') error";
  }
  if (str.indexOf("GET") != 0)
  {
    this.onError(new Error("Unexpected " + JSON.stringify(String.fromCharCode(buffer[i])) + " at position " + i + " in state " + toknam(this.tState)+" buffer:"+str));
  }
};
...
proto.parseError = function (token, value) {
  ...
  if (str.indexOf("GET") != 0)
  {
    console.log("json parse error,buf:",JSON.stringify(this.value));
    this.pop();
    if (value == "{")
       this.onToken(LEFT_BRACE,value);
  }
  this.onError(new Error("Unexpected " + toknam(token) + (value ? ("(" + JSON.stringify(value) + ")") : "") + " in state " + toknam(this.state)+ " buf:"+str));
};
proto.onError = function (err) { };
proto.push = function () {
